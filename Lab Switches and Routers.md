...
|----------------------|--------------------|----------------------|---------------------------------------------------|---------------------|
| **192.168.0.0/24**   | mgmt               | 192.168.0.1 ✓        | 10.1.10.0/24, 192.168.1.0/24, 172.16.x.x/24, 172.18.1.0/24 | ✓                   |
|                      | storage            | 192.168.0.2          | 10.1.10.0/24, 192.168.0.0/24, 192.168.1.0/24, 172.16.x.x/24, 172.18.1.0/24 |                     |
|                      | data               | 192.168.0.3          | 10.1.10.0/24, 192.168.0.0/24, 192.168.1.0/24, 172.16.x.x/24, 172.18.1.0/24 |                     |
| **10.1.10.0/24**     | mgmt               | 10.1.10.61 ✓         | 192.168.0.0/24, 192.168.1.0/24, 172.16.x.x/24, 172.18.1.0/24 | ✓                   |
|                      | storage            | 10.1.10.62           | 192.168.0.0/24, 192.168.1.0/24, 172.16.x.x/24, 172.18.1.0/24 |                     |
|                      | data               | 10.1.10.63           | 192.168.0.0/24, 192.168.1.0/24, 172.16.x.x/24, 172.18.1.0/24 |                     |
| **192.168.1.0/24**   | Routed by mgmt     | N/A                  | 10.1.10.0/24, 192.168.0.0/24, 172.16.x.x/24, 172.18.1.0/24 | ✓                   |
| **172.16.x.x/24**    | Managed by storage | N/A                  | 192.168.0.0/24, 10.1.10.0/24, 172.18.1.0/24        |                     |
| **172.18.1.0/24**    | Managed by data    | N/A                  | 192.168.0.0/24, 10.1.10.0/24, 172.16.x.x/24        |                     |
